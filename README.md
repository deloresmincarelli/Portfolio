...
<img src="https://github.com/deloresmincarelli/Portfolio/blob/main/images/portfolio.png" width="500" />
...
#### [Professionals Like Me](https://github.com/deloresmincarelli/Portfolio/blob/main/Multi_Layered_Resume_Semantic_Analysis.pdf)
...
Example where SDV did a good job |  Example where SDV did not do a good job
:---------------------------------------------:|:-------------------------:
...
<br> You can see the results displayed, along with the query that it generated.  Note, OpenAI had to join two tables with **no guidance** from me on how to do the join.  
